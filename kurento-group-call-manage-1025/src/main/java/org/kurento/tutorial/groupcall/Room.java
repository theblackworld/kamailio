...
public class Room implements Closeable {
  ...
  public Room(String roomName, MediaPipeline pipeline, String presenter, int scale) {
    this.name = roomName;
  ...
  public UserSession join(String userName, WebSocketSession session) throws IOException {
    ...
    final UserSession participant = new UserSession(userName, this.name, session, this.pipeline);//新建与会者UserSession
    joinRoom(participant);//加入房间，通知所有房间内的与会者有新人到来
    participants.put(participant.getName(), participant);
    sendParticipantNames(participant);//告知新与会者当前房间的与会者信息
    return participant;
  }
...
//1.通知所有房间内的与会者有新人到来
  ...
  public void sendParticipantNames(UserSession user) throws IOException {
    ...
    user.sendMessage(existingParticipantsMsg);//告知新与会者当前房间的与会者信息
  }
